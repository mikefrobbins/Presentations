...
<#
    A single workstation running Windows 10 version 1903 is used throughout this demo.
...
<#
    Aliases and Positional Parameters - Avoid aliases and positional parameters in scripts, functions, and any code that you share.
...
psEdit U:\GitHub\PowerShell\MrToolkit\Public\Test-MrIpAddress.ps1
...
psEdit $Path\PlasterTemplate\Module.psm1
